...
export default function Page() {
  ...
  useEffect(() => {
    ...
    try {
      const maybeName = window.localStorage.getItem("iq_local_user_name");
      if (maybeName && maybeName.trim()) setLocalUserName(maybeName.trim());
            ...
            <div className="sidebar-user">
              ...
              {!sidebarCollapsed && (
                <div className="sidebar-user-info">
                  <div className="sidebar-user-name">IQBAR</div>
